...
var _engine3D = require("./unity/facs/engine3d");
var _engine3DDefault = parcelHelpers.interopDefault(_engine3D);
var _unitySettings = require("./unity/UnitySettings");

},{"jquery":"hgMhh","./unity/facs/engine3d":"ekN7e","./unity/UnitySettings":"athEH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"ekN7e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"athEH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _engineWebGLU3DJs = require("./facs/EngineWebGL_u3d.js");
var _engineWebGLU3DJsDefault = parcelHelpers.interopDefault(_engineWebGLU3DJs);
var _facsLibJs = require("./facs/FacsLib.js");
let unityWebGLContentLoaded = false; //read by VirtualysCharacter module
const character = {
    id: "001_FEMALE_CAU",
    name: "Amy",
    ...
    path: "https://evalibre.blob.core.windows.net/evalibre/001_FEMALE_CAU_2019_05_06/webgl.json",
...
var engine = new (0, _engineWebGLU3DJsDefault.default)();
var facslib = new (0, _facsLibJs.FacsLib)(engine);
...
},{"./facs/EngineWebGL_u3d.js":"bfCa1","./facs/FacsLib.js":"bRoUN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bfCa1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _engine3DJs = require("./engine3d.js");
const Engine3D = (0, _engine3DJs.Engine3D);
function EngineWebGL_u3d() {
    //appel au constructeur de la class parent
    (0, _engine3DJs.Engine3D).call(this);
...
EngineWebGL_u3d.prototype = Object.create((0, _engine3DJs.Engine3D).prototype, {
    load: {
        ...
        value: function(targetWeights, smoothTimes) {
            ...
            for(var i = 0; i < this.unityBlendshapes.length; i = i + 1){
                ...
                if ("AUid" in blendshape) {
                    ...
                    AUIndex = this.FacsLib.ActionUnitsList.findIndex(function(elem, index, array) {
                        return elem.id == AUid;
                    });
                    ...
                    VisemeIndex = this.FacsLib.VisemesList.findIndex(function(elem, index, array) {
                        return elem.name == VisemeName;
                    });
            ...
            var param = "";
            for(var i = 0; i < this.unityBlendshapes.length; i = i + 1)//console.log(i);
            ...
            var param = "";
            for(var i = 0; i < this.unityBoneshapes.length; i = i + 1)param = param + this.boneWeights[i].toFixed(1) + ";" + this.boneSmoothTimes[i].toFixed(1) + ";";
...
exports.default = EngineWebGL_u3d;

},{"./engine3d.js":"ekN7e","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bRoUN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FacsLib", ()=>FacsLib);
function FacsLib(engine1) {
    this.defaultIntensity = "C";
    if (engine1 instanceof Engine3D) this.engine = engine1;
    else throw Error("Bad engine");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["75sNA","gLLPy"], "gLLPy", "parcelRequireb012")
